package lambda_fuctional_programming;

import lambda_fuctional_programming.Courses;
...
public class Fp05 {
    public static void main(String[] args) {
        ...
        System.out.println(checkAvarageScoresToBeGreaterThanGivenNumber(coursesList,90));

        System.out.println(checkIfAnyCourseContainsGivenWord(coursesList,"Dayt"));

        System.out.println(getCourseNameWhoseAvarageIsTheHighest(coursesList));
...
//1)Create a method to check if all average scores are greater than given number
    ...
    public static boolean checkAvarageScoresToBeGreaterThanGivenNumber(List<Courses> list,double avgScore){
...
//2)Create a method to check if at least one of the course names contains given word
    ...
    public static  String getCourseNameWhoseAvarageIsTheHighest(List<Courses>list){
