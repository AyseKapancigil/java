...
public class StringBuilder01 {
    ...
    public static void main(String[] args) {
       ...
       int numOfChars2=  sb11.length();
        System.out.println(numOfChars2);

        String str4 = "Ozan";
        StringBuilder sb14 = new StringBuilder(str4);
        sb14.reverse();
        System.out.println(sb14);
        System.out.println(str4);

        String str5 = "Ayse";
        StringBuilder sb15 = new StringBuilder(str5);
        sb15.delete(0,2);
        System.out.println(sb15);

          StringBuilder  sb16 = new StringBuilder("Sena Elis");
           int cap = sb16.capacity();
        System.out.println(cap);

        StringBuilder  sb17 = new StringBuilder("Sena Elis");
         int numOFChars5 = sb17.length();
        System.out.println(numOFChars5);

        StringBuilder  sb18 = new StringBuilder("Sena Elis");
        sb18.deleteCharAt(4);
        System.out.println(sb18);

        StringBuilder  sb19 = new StringBuilder("Sena Elis");
        sb19.append(" "  +"Ozan Ayse");
